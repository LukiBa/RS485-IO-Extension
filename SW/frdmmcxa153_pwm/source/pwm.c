...
static void PWM_DRV_Init3PhPwm(void)
{
    ...
    uint16_t pwmPeriod = (PWM_SRC_CLK_FREQ>>2) / pwmFrequencyInHz;
    ...
    pwmSignal[2].dutyCyclePercent = 90;
...
int main(void)
{
    ...
    GPIO_PinInit(BOARD_INH_DIM_1u2_GPIO, BOARD_INH_DIM_1u2_GPIO_PIN, &inh_config);
    ...
    while (1U)
    {
        ...
        GPIO_PinWrite(BOARD_INH_DIM_1u2_GPIO,BOARD_INH_DIM_1u2_GPIO_PIN,0u);
        //GPIO_PortToggle(BOARD_INH_DIM_1u2_GPIO,BOARD_INH_DIM_1u2_GPIO_PIN_MASK);
        /* Update duty cycles for all 3 PWM signals */
        /*PWM_UpdatePwmDutycycle(BOARD_PWM_BASEADDR, kPWM_Module_0, kPWM_PwmA, kPWM_EdgeAligned, pwmVal);
        PWM_UpdatePwmDutycycle(BOARD_PWM_BASEADDR, kPWM_Module_1, kPWM_PwmA, kPWM_EdgeAligned, (pwmVal >> 1));
        PWM_UpdatePwmDutycycle(BOARD_PWM_BASEADDR, kPWM_Module_2, kPWM_PwmA, kPWM_EdgeAligned, (pwmVal >> 2));
        PWM_UpdatePwmDutycycle(BOARD_PWM_BASEADDR, kPWM_Module_0, kPWM_PwmB, kPWM_EdgeAligned, 10);
        PWM_UpdatePwmDutycycle(BOARD_PWM_BASEADDR, kPWM_Module_1, kPWM_PwmX, kPWM_EdgeAligned, 30);*/
        /* Set the load okay bit for all submodules to load registers from their buffer */
        // PWM_SetPwmLdok(BOARD_PWM_BASEADDR, kPWM_Control_Module_0 | kPWM_Control_Module_1 | kPWM_Control_Module_2, true);
        PWM_UpdatePwmDutycycle(BOARD_PWM_BASEADDR, kPWM_Module_0, kPWM_PwmA, kPWM_EdgeAligned, 30);
        PWM_UpdatePwmDutycycle(BOARD_PWM_BASEADDR, kPWM_Module_2, kPWM_PwmX, kPWM_EdgeAligned, 50);
        PWM_SetPwmLdok(BOARD_PWM_BASEADDR, kPWM_Control_Module_0 | kPWM_Control_Module_1 | kPWM_Control_Module_2, true);
    }
}
